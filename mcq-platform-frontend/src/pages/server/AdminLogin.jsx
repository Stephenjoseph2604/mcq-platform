  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setMessage({ type: 'error', text: response.data.message || 'Admin login failed!' });
      } 
    } catch (error) {
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-6">
        <div className="w-full max-w-sm bg-[var(--color-card)] border border-[var(--color-muted)]/50 rounded-2xl p-8 shadow-xl">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-[var(--color-text)] mb-2">Admin Login</h1>
            <p className="text-[var(--color-text-muted)] text-sm">Sign in to admin panel</p>
          </div>
